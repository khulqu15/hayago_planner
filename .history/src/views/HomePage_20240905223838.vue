        ...
        <div class="pt-24 pb-8 px-8 w-full">
          <div class="w-full grid grid-cols-3 gap-3">
            <div class="md:col-span-1 col-span-3 space-y-3">
              ...
              <div class="w-full bg-base-200 space-y-3 min-h-[25vh] p-4 rounded-2xl">
                <div class="flex items-center justify-between">
                  <div class="font-bold">Home</div>
                  <div class="text-sm">-7.276606, 112.793865</div>
                  <div class="flex items-center gap-3">
                    <button class="btn btn-error btn-sm"><Icon icon="streamline:delete-1"/></button>
                  </div>
                </div>
                <div class="flex items-center justify-between">
                  <div class="font-bold">Waypoint 1</div>
                  <div class="text-sm">-7.276606, 112.793865</div>
                  <div class="flex items-center gap-3">
                    <button class="btn btn-error btn-sm"><Icon icon="streamline:delete-1"/></button>
                  </div>
...
const addWaypoint = (e: any) => {
  const newWaypoint = {
    name: `Waypoint ${waypoints.value.length}`,  // Waypoint name iterates
    lat: e.latlng.lat,
    lng: e.latlng.lng,
  };
