    ...
    <ion-content :fullscreen="true">
      <div id="container" class="w-full min-h-screen bg-base-300 text-base-content">
        <div class="w-full fixed top-0 left-0 p-3 flex justify-between items-center">
          ...
          <div class="fixed top-0 left-0 p-8 min-h-screen bg-base-300 shadow-2xl space-y-2 z-10 max-w-sm w-full items-center gap-2">
            <div>
              <button class="btn bg-base-200 hover:bg-base-200"><Icon class="text-2xl" icon="material-symbols:close"/> Close</button>
            </div>
            <div>
