          ...
          <div class="w-full grid grid-cols-3 gap-3">
            ...
            <div class="md:col-span-2 col-span-3 space-y-3">
              <div class="w-full bg-blue-600 relative min-h-[50vh] h-[50vh] overflow-hidden rounded-2xl">
                <div class="absolute text-sm right-0 top-0 p-3 m-3 rounded-xl bg-blue-500 text-white flex items-center gap-2"><Icon icon="solar:camera-bold"/> Live Camera</div>
