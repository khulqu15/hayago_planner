        ...
        <div class="pt-24 pb-8 px-8 w-full">
          <div class="w-full grid grid-cols-3 gap-3">
            <div class="md:col-span-1 col-span-3 space-y-3">
              <div class="w-full bg-blue-600 h-[77vh] min-h-[76vh] overflow-hidden rounded-2xl">
            ...
            <div class="md:col-span-2 col-span-3 space-y-3">
              ...
              <div class="w-full bg-base-200 min-h-[25vh] p-2 rounded-2xl">
                <div class="w-full grid grid-cols-3">
                  <div class="col-span-1 w-full h-[23vh] rounded-xl flex items-center justify-center"></div>
                  <div class="col-span-2 w-full h-[23vh] bg-base-100 rounded-xl"></div>
                </div>
              </div>
            </div>
          </div>
