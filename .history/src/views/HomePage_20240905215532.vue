        ...
        <div class="pt-24 pb-8 px-8 w-full">
          <div class="w-full grid grid-cols-3 gap-3">
            <div class="md:col-span-1 col-span-3 space-y-3">
              <div class="w-full bg-blue-600 min-h-[50vh] rounded-2xl">
                <l-map class="w-full h-full" ref="map" :use-global-leaflet="false" v-model="zoom" v-model:zoom="zoom" :center="[47.41322, -1.219482]">
                  <l-tile-layer
